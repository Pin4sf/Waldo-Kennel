...
| Project-local `.ao/attachments` and `.ao/launch.json` | Active inherited project file formats | Retain until an additive `.kennel` format, dual-read migration, and downstream inventory exist. |
