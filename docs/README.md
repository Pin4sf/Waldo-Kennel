...
| Document | Purpose |
| --- | --- |
| [Waldo Kennel v0 dogfood and provider-neutral v1 architecture](product/kennel-v1-product-architecture.md) | Canonical three-destination, five-stage local Home + Work thesis, responsibility ontology, governance, provider-neutral adapter/conformance seam, capability-based v0 provider admission (Codex ready-by-default; DeepSeek Harness for workers after profile readiness), RunBrief compilation, dogfood gate, and implementation entry. It is a design baseline, not a shipped-feature claim. |
...
| [Work control plane and canonical user flow](superpowers/specs/2026-08-25-work-control-plane-canonical-flow-design.md) | Approved board-first composition from Project setup and persistent Project conversation through adaptive Outcome Contract, Mission Control, Session Inspector, bounded provider continuation, proof, acceptance, and governed Project learning. |
| [Work experience screen and interaction specification](superpowers/specs/2026-08-25-work-experience-screen-interaction-spec.md) | Designer- and implementation-ready Work brief covering every Project, Outcome, Mission, Waldo, session, proof, recovery, and learning surface; exact forms, states, transitions, micro-interactions, responsive behavior, truth boundaries, and review frames. |
| [Work experience visual guide](product/kennel-work-experience-visual-guide.html) | Self-contained interactive HTML explanation of the final Work product: Outcome-first ontology, seven-step journey, Board -> Mission Control -> Session Inspector hierarchy, persistent Project Waldo, adaptive Mission topologies, authority, proof, learning boundaries, screen atlas, and resolved product questions. It is a communication artifact, not shipped UI. |
...
| [ADR 0007: Composed Outcomes](adr/0007-composed-outcomes.md) | Accepted Work-lane ontology amendment: one Project-level Outcome may decompose into independently governed contributing Outcomes, with criterion-bound contribution, containment of authority, proof roll-up, and batched acceptance that never delegates authority. |
| [Composed Outcomes program plan](superpowers/plans/2026-08-29-composed-outcomes-program.md) | Gap analysis against `beta`, the composition invariants, and six phases from the recorded decision through Board/Mission Control navigation and the supervision-cost evaluation gate. |
| [Composed Outcomes handoff, 2026-08-30](superpowers/plans/2026-08-30-composed-outcomes-handoff.md) | Post-merge continuation snapshot for a fresh session: verified repo state, what shipped vs. what is explicitly not done, and the linear-history rebase lesson. |
...
| [Work control-plane delivery plan](superpowers/plans/2026-08-25-work-control-plane-delivery.md) | Dependency-aware vertical slices for Project agent defaults, durable Project conversation, adaptive intake, Outcome Mission Control/Session Inspector, bounded continuation, and one evaluated adaptive multi-Work-Unit Mission. Its Task 5 multi-Work-Unit slice is superseded by [ADR 0007](adr/0007-composed-outcomes.md). |
| [Island + app unification plan](plans/island-app-unification.md) | Accepted decisions and implementation record for running the workspace, notch Island, and detailed Island settings from one Electron process, including lifecycle, live updates, session routing, and verification. |
