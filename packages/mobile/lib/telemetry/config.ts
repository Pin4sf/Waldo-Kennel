...
/**
 * Kill switches, mirroring the desktop's KENNEL_TELEMETRY_DISABLED_EVENTS. Build-time
...
export const MOBILE_TELEMETRY_DISABLED =
	(process.env.EXPO_PUBLIC_KENNEL_TELEMETRY_DISABLED ?? "").trim() === "1";

export const MOBILE_DISABLED_EVENTS = (process.env.EXPO_PUBLIC_KENNEL_TELEMETRY_DISABLED_EVENTS ?? "")
	.split(",")
