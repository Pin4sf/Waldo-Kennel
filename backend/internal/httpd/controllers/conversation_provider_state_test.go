...
// The wire shape of the provider state Kennel used to drop. These assert the JSON a
...
// produce it. It is deliberately separate from `settings`, which says what Kennel asked
