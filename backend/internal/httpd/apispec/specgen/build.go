...
var schemaNames = map[string]string{
	...
	"ControllersCreateContributionRequest":                "CreateContributionRequest",
...
func notificationOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/outcomes/{outcomeId}/contributions", id: "createOutcomeContribution", tag: "outcomes",
			summary:    "Add one contributing Outcome bound to parent criteria",
			pathParams: []any{controllers.OutcomeIDParam{}},
			reqBody:    controllers.CreateContributionRequest{},
			resps: []respUnit{
				{http.StatusCreated, controllers.OutcomeEnvelope{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
