...
import (
	...
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/agy"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/aider"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/amp"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/auggie"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/autohand"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/claudecode"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/cline"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/codex"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/continueagent"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/copilot"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/crush"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/cursor"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/devin"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/droid"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/goose"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/grok"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/kilocode"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/kimchi"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/kimi"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/kiro"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/muse"
	...
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/qwen"
	"github.com/Pin4sf/Waldo-Kennel/backend/internal/adapters/reviewer/vibe"
