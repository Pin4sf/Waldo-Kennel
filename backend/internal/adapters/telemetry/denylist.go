...
// names. An entry ending in "*" matches by prefix, so "kennel.renderer.*" silences a
...
// name they see in PostHog ("kennel.v2.app.active") or the one in the source
// ("kennel.app.active") and get the result they expect.
