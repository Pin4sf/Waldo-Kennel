...
const (
	...
	// ProjectKindScratch is Kennel-managed plain-directory work for first-run use.
...
type ProjectRecord struct {
	...
	Kind          ProjectKind
	// Config holds the typed per-project configuration Kennel resolves at spawn. An
