...
const task = () => screen.getByRole("textbox", { name: "Outcome" });
...
describe("TaskComposer", () => {
	it("requires an outcome before submission", async () => {
		...
		expect(task()).toHaveAttribute("placeholder", "Describe the result you want Kennel to deliver…");
	...
	it("emits busy state around an in-flight create and reports the new session", async () => {
		...
		fireEvent.click(screen.getByText("Define outcome"));
