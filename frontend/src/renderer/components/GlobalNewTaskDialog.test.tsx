...
describe("GlobalNewTaskDialog", () => {
	...
	it("opens for the requested project and returns to its Kanban board", async () => {
		...
		expect(navigateMock).toHaveBeenCalledWith({ to: "/projects/$projectId", params: { projectId: "proj-7" } });
	});
